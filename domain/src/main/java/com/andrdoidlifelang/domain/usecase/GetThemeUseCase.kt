...
class GetThemeUseCase(private val settingRepository: SettingRepository) :
    BaseFlowUseCase<Unit, Theme>() {

    override fun execute(params: Unit): Flow<UseCaseResult<Theme>> = settingRepository.getTheme()
}
