...
class GetThemeObservableUseCase(private val themeRepository: ThemeRepository) : BaseFlowUseCase<Unit, Theme>() {

    override fun execute(params: Unit): Flow<UseCaseResult<Theme>> = themeRepository.getThemeObservable()
}
