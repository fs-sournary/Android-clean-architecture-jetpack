...
import com.andrdoidlifelang.data.util.Constant.ACCESS_TOKEN_KEY
import com.andrdoidlifelang.data.util.Constant.DEF_PREF_STRING
import com.andrdoidlifelang.data.util.Constant.PREF_DARK_MODE_ENABLE
...
class AppPreferenceImpl(context: Context) : AppPreference {
    ...
    private val changeListener = OnSharedPreferenceChangeListener { _, key ->
        when (key) {
            PREF_DARK_MODE_ENABLE -> selectedTheme.offer(getTheme())
        }
    }
    ...
    override fun setAccessToken(accessToken: String) {
        pref.edit { putString(ACCESS_TOKEN_KEY, accessToken) }
    }

    override fun getAccessToken(): String? = pref.getString(ACCESS_TOKEN_KEY, DEF_PREF_STRING)

    override fun setTheme(theme: String) {
        pref.edit { putString(PREF_DARK_MODE_ENABLE, theme) }
    }

    override fun getTheme(): String =
        pref.getString(PREF_DARK_MODE_ENABLE, null) ?: Theme.SYSTEM.storageKey
